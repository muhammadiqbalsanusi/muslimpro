  ...
  <div class="container mt-5">
    <div class="row content mt-5">
      ...
      <div class="col-md-6 mt-4">
        <h3 class="signin-text mb-3 text-left">Sign In</h3>
        ...
        <div class="form-group mt-5 ml-5 center">
          <!-- <GoogleLogin
            :params="params"
...
export default {
  data() {
    return {
      ...
      params: {
        client_id:
          "438046230128-14qmut1op1ibl3ao5aid7bi4q7vfh1h9.apps.googleusercontent.com",
      },
      renderParams: {
        width: 350,
        height: 50,
